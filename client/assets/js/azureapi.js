...
$.ajax({
  ...
  processData: false
   ...
   .done(function (response) {
     ...
     if (result === 'happiness') {
         $('#hasil').empty().append('<img id="img-result" src="https://imgur.com/ReRgu1N.jpg" height="72px" width="72px">')
     } else {
        $('#hasil').empty().append('<img id="img-result" src="https://imgur.com/DdHuPH5.jpg" height="72px" width="72px">')
     }
   })
   .fail(function (error) {
